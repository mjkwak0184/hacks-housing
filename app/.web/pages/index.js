...
import { Box, HStack, Image, Link, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Spacer, Text, Tooltip, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Spacer sx={{"size": "2em"}}/>
  <Image src={`https://www.brayerelectric.com/wp-content/uploads/2020/11/AnnaHead_Final.jpg`} sx={{"width": "50%", "height": "50%"}}/>
</HStack>
  <HStack>
  <Text sx={{"color": "#003262", "backgroundColor": "#FDB515", "textTransform": "uppercase", "font-weight": "bold", "font-size": "10pt", "padding": "6px 10px 6px 10px", "border-radius": "100px", "width": "50%"}}>
  ...
  <HStack sx={{"align": "left"}}>
  <Text sx={{"width": "50%"}}>
  {`No more compromise between price and distance.                     Whether you want a cozy spot just a stone's throw from Berkeley or a serene escape a little further out,                     our platform is designed to find the best matches, tailored just for you.`}
</Text>
  <Spacer sx={{"size": "2em"}}/>
  <Text sx={{"width": "50%"}}>
  {`Enjoy a streamlined, efficient, and personalized home hunting experience with [Your Startup Name].                     Because your ideal home, at the right price and distance, is waiting.`}
</Text>
  <Spacer sx={{"size": "2em"}}/>
  <Text>
  {`what`}
